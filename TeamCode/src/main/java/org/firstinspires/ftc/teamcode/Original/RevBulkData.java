...
public class RevBulkData {
     ...
     * the corresponding method that takes a Spinnable parameter
     ...
     *         the Spinnable object passed in
     */
//    public int getMotorCurrentPosition(Spinnable motor)
//    {
...
//    }
     ...
     *         the Spinnable object passed in
     */
//    public int getMotorVelocity(Spinnable motor)
//    {
//        throwIfMotorInvalid(motor);
...
//    }
     ...
     *         encoder position as retrieved from this bulk packet
     */
//    public boolean isMotorAtTargetPosition(Spinnable motor)
//    {
//        throwIfMotorInvalid(motor);
...
//        }
     ...
     */
//    private void throwIfMotorInvalid(Spinnable motor)
//    {
